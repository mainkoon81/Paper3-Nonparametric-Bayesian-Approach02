...
#-------------------------------------------------------------------------------
##### Brazilian Data with overall error: [10%]
#-------------------------------------------------------------------------------
full.train.brazil <- read.csv("C:/Users/kimm4/Desktop/WORKSPACE/2nd 3rd paper/DATASET/Brazil.paper3-10.train.csv")
full.test.brazil <- read.csv("C:/Users/kimm4/Desktop/WORKSPACE/2nd 3rd paper/DATASET/Brazil.paper3-10.test.csv")
...
for(h in 1:n.train) {
  ...
  for(j in 1:M) {
    ...
    sumES.st[j] = 2*exp(sum(matXstar[h,]*beta_samplej) - sig_samplej/2)*(1-pnorm(-xi_samplej*sqrt(sig_samplej)/sqrt(xi_samplej^2+1)))
