...
sh_out_xx <- list()
for(j in 1:Nsh) {
  sh_out_xx[[j]] <- readRDS( paste("testtt/xx.shard_0.25(",j,")data.rds",sep="") )
}
...
lppd_EX_DP.S.xx <- mean( loglikelihood.xx ); lppd_EX_DP.S.xx # -668788
...
SSPE.DP.LSN.xx <- sum( (log(expS.DP.Avg.test.xx) - log(S.test))^2 ); SSPE.DP.LSN.xx   # 18799.83
SAPE.DP.LSN.xx <- sum( abs(log(expS.DP.Avg.test.xx) - log(S.test)) ); SAPE.DP.LSN.xx  # 4984.581
lppd_EX_DP.S.xx                                                                       # -668788
...
summary(list_betaparam0.xx)# 10.05
...
summary(list_betaparam1.xx)# 0.06    
...
summary(list_betaparam2.xx) #-1.15 
...
summary(list_sig2test.xx ) #14.28     
...
#1) zeta =0.99 -----------------------------------------------------------------
for(j in 1:Nsh) {
  sh_out_st[[j]] <- readRDS( paste("testtt/st.shard_0.25_0.99(",j,")data.rds",sep="") )
}

#1) zeta =0.90
for(j in 1:Nsh) {
  sh_out_st[[j]] <- readRDS( paste("testtt/st.shard_0.25_0.90(",j,")data.rds",sep="") )
}

#1) zeta =0.95
for(j in 1:Nsh) {
  sh_out_st[[j]] <- readRDS( paste("testtt/st.shard_0.25_0.95(",j,")data.rds",sep="") )
}

#1) zeta =0.85
for(j in 1:Nsh) {
  sh_out_st[[j]] <- readRDS( paste("testtt/st.shard_0.25_0.85(",j,")data.rds",sep="") )
}

#1) zeta =0.80
for(j in 1:Nsh) {
  sh_out_st[[j]] <- readRDS( paste("testtt/st.shard_0.25_0.80(",j,")data.rds",sep="") )
}
#-------------------------------------------------------------------------------
...
lppd_EX_DP.S.st <- mean( loglikelihood.st ); lppd_EX_DP.S.st #-679550.6(0.99) -679375.1(0.9) -678344.4(0.95) -679956.1(0.80)
...
SSPE.DP.LSN.st <- sum( (log(expS.DP.Avg.test.st) - log(S.test))^2 ); SSPE.DP.LSN.st   #18013.4(0.99) 15839.74(0.90) 17940.7(0.95) 14860.32(0.80)
SAPE.DP.LSN.st <- sum( abs(log(expS.DP.Avg.test.st) - log(S.test)) ); SAPE.DP.LSN.st  #5294.924(0.99) 4647.637(0.90) 5262.725(0.95) 4988.117(0.80)
...
summary(list_betaparam0.st)# ?(zeta0.85);  10.01(zeta0.9); (zeta0.95); 10.00(zeta0.99)
...
summary(list_betaparam1.st)# ?(zeta0.85);  0.06(zeta0.9); (zeta0.95); 0.06(zeta0.99)
...
summary(list_betaparam2.st) # ?(zeta0.85);  -1.10(zeta0.9); (zeta0.95); -1.09(zeta0.99)
...
summary(list_sig2test.st ) # ?(zeta0.85);  8.42(zeta0.9); (zeta0.95); 9.42(zeta0.99)
...
summary(list_xitest.st ) # ?(zeta0.85);  -0.45(zeta0.9); (zeta0.95); -0.44(zeta0.99)
...
summary(list_tau2test.st ) # ?(zeta0.85);  8.42(zeta0.9); (zeta0.95); 1.62(zeta0.99)
...
#1) zeta=0.99 ------------------------------------------------------------------
for(j in 1:Nsh) {
  sh_out_HB.st[[j]] <- readRDS( paste("testtt/HB.st.shard_0.25_0.99(",j,")data.rds",sep="") )
}

#1) zeta=0.90
for(j in 1:Nsh) {
  sh_out_HB.st[[j]] <- readRDS( paste("testtt/HB.st.shard_0.25_0.90(",j,")data.rds",sep="") )
}

#1) zeta=0.95
for(j in 1:Nsh) {
  sh_out_HB.st[[j]] <- readRDS( paste("testtt/HB.st.shard_0.25_0.95(",j,")data.rds",sep="") )
}

#1) zeta=0.85
for(j in 1:Nsh) {
  sh_out_HB.st[[j]] <- readRDS( paste("testtt/HB.st.shard_0.25_0.85(",j,")data.rds",sep="") )
}

#1) zeta=0.80
for(j in 1:Nsh) {
  sh_out_HB.st[[j]] <- readRDS( paste("testtt/HB.st.shard_0.25_0.80(",j,")data.rds",sep="") )
}
#-------------------------------------------------------------------------------
...
lppd_EX_HB.S.st = mean( loglikelihood.HB.st ); lppd_EX_HB.S.st # -758079.5(0.99) -758083(0.90) -758084.7(0.95) -758014.5(0.8)
...
SSPE.HB.LSN.st <- sum( (log(expS.HB.test.st) - log(S.test))^2 ); SSPE.HB.LSN.st   # 16129.76
SAPE.HB.LSN.st <- sum( abs(log(expS.HB.test.st) - log(S.test)) ); SAPE.HB.LSN.st  # 5018.573
lppd_EX_HB.S.st                                                                   # -758014.5
...
lines(density( log(expS.DP.Avg.test.st)+2.2 ), col="blue", lwd=7) # dirty with correction
lines(density( log(expS.HB.test.st)+2 ), col="green", lwd=4) # dirty with correction
